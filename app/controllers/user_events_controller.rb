class UserEventsController < ApplicationController
  ...
  def create
    ...
    if existing_user_event
      redirect_to new_event_user_event_path(@event), notice: "L'utilisateur est déjà ajouté à l'événement."
    else
      ...
      if @user_event.save
        redirect_to new_event_user_event_path(@event), notice: "Utilisateur ajouté à l'événement avec succès!"
      else
